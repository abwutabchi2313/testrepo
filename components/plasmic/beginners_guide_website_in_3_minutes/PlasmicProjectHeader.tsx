...
import sty from "./PlasmicProjectHeader.module.css"; // plasmic-import: CFXt3W54VNFC/css
...
function PlasmicProjectHeader__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.columns__aQkAj)}>
        <div className={classNames(projectcss.all, sty.column__t8Fv0)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.column___6MkV0)}>
          <div className={classNames(projectcss.all, sty.columns__dys8M)}>
            <div className={classNames(projectcss.all, sty.column__wsJQz)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__sSdiO)}>
                {renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.column__e8GHv)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__gl6Ut)}>
                {renderPlasmicSlot({
