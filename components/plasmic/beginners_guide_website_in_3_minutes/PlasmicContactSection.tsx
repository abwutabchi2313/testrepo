...
import sty from "./PlasmicContactSection.module.css"; // plasmic-import: dLjgIKMvOPkb/css
...
function PlasmicContactSection__RenderFunc(props: {
  ...
  return (
    <Stack__
      ...
      id={"contact"}
    >
      <div className={classNames(projectcss.all, sty.freeBox__mREn)}>
        <h2
        ...
        <div className={classNames(projectcss.all, sty.freeBox___7ZTo8)}>
          <PlasmicLink__
